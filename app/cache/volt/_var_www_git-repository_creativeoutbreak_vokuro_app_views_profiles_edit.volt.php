...
<ul class="pager">
    <li class="previous pull-left">
        <?php echo $this->tag->linkTo(array('profiles', '&larr; Go Back')); ?>
    </li>
    <li class="pull-right">
            ...
            <div class="tab-pane" id="B">
                <p>
                    <table class="table table-bordered table-striped" align="center">
                        ...
                        <tbody>
                        <?php $v128659548522934475971iterated = false; ?><?php foreach ($profile->users as $user) { ?><?php $v128659548522934475971iterated = true; ?>
                            <tr>
                        ...
                        <?php } if (!$v128659548522934475971iterated) { ?>
